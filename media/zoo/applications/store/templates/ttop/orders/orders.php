	...
	<table class="uk-table uk-table-condensed uk-table-striped uk-table-hover order-table">
		<thead>
			<tr>
				...
				<th class="uk-width-1-10">Order Status</th>
				<th class="uk-width-1-10">Payment Status</th>
		...
		<tbody>
			...
			<tr>
				<td class="uk-text-center" ><a class="uk-button uk-button-primary" href="account/orders/all-orders?task=order&id=<?php echo $order->id; ?>">View</a></td>
		...
		<tfoot>
			<tr>
				<td colspan="7" class="uk-text-right">Total:</td>

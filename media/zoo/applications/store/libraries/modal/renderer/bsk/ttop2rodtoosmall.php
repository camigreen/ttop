...
<div class="uk-grid">
	<div class="uk-width-1-1">
		<p>Boats with a T-Top to Rod Holder measurement less than <?php echo $value; ?> inches are too small for our Boat Shade Kit.</p>
...
jQuery(function($){
	$(document).ready(function(){
		$('#bsk-ttop2rodtoosmall-modal').on('save', function(e, data){
			window.location = '/about-us/contact-us';
			data.result = true;
        });
        $('#bsk-ttop2rodtoosmall-modal').on('cancel', function(e, data){
